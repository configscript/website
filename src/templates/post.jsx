...
const Post = ({post, meta}) => {
  return (
    <>
      <Helmet
        title={`${post.post_title[0].text} | ConfigScript`}
        ...
        meta={[
          ...
          {
            property: `og:title`,
            content: `${post.post_title[0].text} | ConfigScript`,
          },
          {
      ...
      <Layout>
        ...
        {post.post_hero_image && (
          <PostHeroContainer>
            ...
            <PostHeroAnnotation>{RichText.render(post.post_hero_annotation)}</PostHeroAnnotation>
          </PostHeroContainer>
        )}
